...
const FilterController = async (req, res) => {
    ...
    if (requests.method == "GET") {
        ...
        else if (requests.filter == "public_pvt") {
            // console.log("areas",requests);
            try {
                const edited = {
                    tenantId: filter.tenantId,
                ...
                const response= await ResourceFilters.findOneAndUpdate({tenantId: requests.tenantId },{public_pvt:requests.data},{ "returnNewDocument": false });
        ...
        else if (requests.filter == "internal_ext") {
            // console.log("areas",requests);
            try {
                const edited = {
                    tenantId: filter.tenantId,
                ...
                const response= await ResourceFilters.findOneAndUpdate({tenantId: requests.tenantId },{internal_ext:requests.data},{ "returnNewDocument": false });
